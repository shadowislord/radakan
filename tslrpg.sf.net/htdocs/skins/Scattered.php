 ...
 * @subpackage Skins
 */
class SkinScattered extends SkinTemplate {
	/** Using scattered. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'scattered';
		$this->stylename = 'scattered';
		$this->template  = 'ScatteredTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class ScatteredTemplate extends QuickTemplate {
	/**
	 * Template filter callback for Scattered skin.
...
<?php		}
		...
		wfRunHooks( 'ScatteredTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>

 ...
 * 
 * @author Johannes Schaback, last edited by $Author: bbeaulant $, $Date: 2006-10-25 06:49:21 -0400 (Wed, 25 Oct 2006) $
 * @version $Revision: 94 $
 */
public class TestFontFactory {

	public static void main(String[] args) {
		org.fenggui.util.fonttoolkit.FengFonts.main(args);
//                
...
//		
//		ImageFont imgFont = ff.createFont();
//		FontFactory.saveImageToDisk(imgFont.getImage(), "hello thar.png");
	}

 ...
 * @created Aug 18, 2008
 */
public class GameTileManager extends Node {

    private static final Logger logger = Logger.getLogger(GameTileManager.class.getName());
     ...
     */
    public GameTileManager(GameWorldManager world, Renderer renderer) {
        super("Tile Manager");
    ...
    public GameWorldManager getWorld(){
        return parentWorld;
    }

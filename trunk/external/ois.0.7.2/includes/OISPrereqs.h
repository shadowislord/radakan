...
#define OIS_VERSION_MAJOR 0
#define OIS_VERSION_MINOR 7
#define OIS_VERSION_PATCH 1
#define OIS_VERSION_NAME "Sonic"
...
namespace OIS
{
	...
	struct _OISExport Axis : Component
	{
		...
		void setAbsValues( int x, int y, int z ) {abX=x; abY=y; abZ=z;}
		void setRelValues( int x, int y, int z ) {relX=x; relY=y; relZ=z;}
		void clear()
		{

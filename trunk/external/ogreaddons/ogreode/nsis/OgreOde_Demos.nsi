...
Section "${PKG_NAME} (required)"
  ...
  SectionIn RO
   ...
   SetOutPath $INSTDIR  
    ...
    File ..\..\OgreSDK\bin\Release\OgreOdeDemo_Landscape.exe        
    File ..\..\OgreSDK\bin\Release\OgreOdeDemo_SimpleScenes.exe     
    File ..\..\OgreSDK\bin\Release\OgreOdeDemo_GranTurismOgre.exe   
    
    File ..\..\OgreSDK\bin\Release\OgreOde_Core.dll                 
    File ..\..\OgreSDK\bin\Release\OgreOde_Prefab.dll                 
    File ..\..\OgreSDK\bin\Release\OgreOde_Loader.dll               
    File ..\..\OgreSDK\bin\Release\ode.dll                          

    File /oname=Plugins.cfg Plugins_ogreode_binary.cfg       
    File /oname=resources.cfg resources_ogreode_binary.cfg     

    File ..\..\OgreSDK\bin\Release\OgreMain.dll                     
    File ..\..\OgreSDK\bin\Release\OgrePlatform.dll                 
    ...
    File ..\..\OgreSDK\bin\Release\devil.dll                        
    File ..\..\OgreSDK\bin\Release\ilu.dll                          
    File ..\..\OgreSDK\bin\Release\zlib1.dll                        

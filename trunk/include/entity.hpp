	...
	public Object
{
	...
	//	protected:
		...
		void remove_from_container (Entity * old_container_parent);
		void put_in_container (Entity * new_container_parent);
		bool is_in_container (const Entity * container) const;

	private:
		Entity * container_parent;	//	the container in which the entity is
};
